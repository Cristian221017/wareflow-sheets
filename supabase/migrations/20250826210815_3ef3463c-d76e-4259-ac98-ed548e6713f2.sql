-- Medidas preventivas contra usuários órfãos
...
-- 4. Policy mais restritiva para profiles - só permite acesso com vínculos válidos
DROP POLICY IF EXISTS "Users can view their own profile" ON profiles;
CREATE POLICY "Users can view their own profile with valid links" 
ON profiles 
FOR SELECT 
USING (
  auth.uid() = user_id 
...
SELECT 'Medidas preventivas implementadas: triggers, validações e limpeza automática' as resultado;