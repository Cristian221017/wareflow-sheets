...
-- 2. Remover default temporariamente, alterar tipo e recriar default
...
-- 3. Adicionar campos de controle
ALTER TABLE public.notas_fiscais 
...
-- 4. Criar funções de transição atômica para evitar estados inválidos
...
-- 5. Habilitar realtime para a tabela notas_fiscais
