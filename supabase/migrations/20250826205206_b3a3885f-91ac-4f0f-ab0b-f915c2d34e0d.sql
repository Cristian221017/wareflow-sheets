-- Primeiro, remover a coluna que foi adicionada incorretamente
ALTER TABLE public.notas_fiscais 
DROP COLUMN IF EXISTS status_separacao;

-- Criar tipo enum para os status de separação
CREATE TYPE IF NOT EXISTS separacao_status AS ENUM ('pendente', 'em_separacao', 'separacao_concluida', 'separacao_com_pendencia');

-- Adicionar coluna corretamente com o tipo enum e valor padrão
ALTER TABLE public.notas_fiscais 
